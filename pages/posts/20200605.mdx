...
開発しているプロジェクトをひらいた状態で Xcode のステータスバーの File > Swift Package > Add Package Dependencies...から Github 上にあるライブラリのリンクを追加してインポートします。
https://github.com/g4zeru/Preparable.git
