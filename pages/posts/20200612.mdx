...
export const meta = {
  title: "SwiftUIを使ってミュージックプレイヤーのシークバーを作ってみた",
  description:
    "ミュージックプレイヤーの機能を満たすためにSwiftUIの機能を使いシークバーを作成してみます。",
};

# SwiftUIを使ってミュージックプレイヤーのシークバーを作ってみた

[使用したプロジェクト](https://github.com/g4zeru/AudioPlayerWithSwiftUI)

## 概要
<Image src="/20200612/image1.png" width="50%"/><br/>
ミュージックプレイヤーのシークバーには主に2つの機能があります。1つ目は再生されている楽曲の再生位置を知らせること、2つ目は現在の再生位置からシークバーをスライドした際に楽曲にスライドした位置を伝えることです。
...
### シークバーをスライドさせて時にMusicPlayerControllerに伝達する
